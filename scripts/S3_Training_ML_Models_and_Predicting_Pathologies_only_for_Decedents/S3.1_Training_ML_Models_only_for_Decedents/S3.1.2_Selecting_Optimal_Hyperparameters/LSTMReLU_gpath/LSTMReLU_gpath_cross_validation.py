...
INPUT_DIR = utils_BiLReLU.RESULTS_DIR / "S1" / "S1.1"
OUTPUT_DIR = utils_BiLReLU.RESULTS_DIR / "S3" / "S3.1" / "S3.1.2" / "LSTMReLU_gpath"
...
for targets in target_sets:
    file_name = f"lstmrelu_results_{'_'.join(targets)}.csv"
