...
INPUT_DIR = utils.DATA_DIR / "raw"
OUTPUT_DIR = utils.RESULTS_DIR / "S3" / "S3.1" / "S3.1.1" / "LSTM"
...
for targets in target_sets:
    filename = OUTPUT_DIR / f"lstm_results_{'_'.join(targets)}.csv"  # Create unique filenames
