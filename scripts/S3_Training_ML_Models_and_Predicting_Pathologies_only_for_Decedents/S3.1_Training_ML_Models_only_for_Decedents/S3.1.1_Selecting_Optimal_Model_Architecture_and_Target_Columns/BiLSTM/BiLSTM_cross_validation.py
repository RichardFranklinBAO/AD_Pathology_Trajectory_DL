...
INPUT_DIR = utils_BiLSTMVersion.DATA_DIR / "raw"
OUTPUT_DIR = utils_BiLSTMVersion.RESULTS_DIR / "S3" / "S3.1" / "S3.1.1" / "BiLSTM"
...
for targets in target_sets:
    filename = OUTPUT_DIR / f"Bilstm_results_{'_'.join(targets)}.csv"  # Create unique filenames
